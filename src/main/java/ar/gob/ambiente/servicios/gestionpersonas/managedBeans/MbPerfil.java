...
public class MbPerfil implements Serializable{
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(perfilFacade.findAll(), false);
    }
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(perfilFacade.findAll(), true);
    }

    private Perfil getPerfil(java.lang.Long id) {
