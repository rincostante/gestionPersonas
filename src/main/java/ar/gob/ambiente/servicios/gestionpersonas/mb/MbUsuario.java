/*
 * Bean de respaldo para la validación de usuarios y selección de las aplicaciones del mismo
 */
...
import ar.gob.ambiente.servicios.gestionpersonas.entidades.Rol;
...
import ar.gob.ambiente.servicios.gestionpersonas.facades.RolFacade;
import ar.gob.ambiente.servicios.gestionpersonas.facades.UsuarioFacade;
import java.io.Serializable;
import javax.xml.ws.WebServiceRef;
import ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.AccesoAppWebService_Service;
import ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.AccesoAppWebService;
import ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.Aplicacion;
...
public class MbUsuario implements Serializable{
    ...
    private List<String> listUsDisponibles; //Lista de pares usNombre - usNombreCompleto disponibles para poblar el combo
    ...
    /**
     * Método para incializar apenas construido el objeto
     */
    @PostConstruct
    public void init(){
        listUsDisponibles = new ArrayList();
        iniciado = false;
    ...
    public List<String> getListUsDisponibles() {
        return listUsDisponibles;
    }

    public void setListUsDisponibles(List<String> listUsDisponibles) {
        this.listUsDisponibles = listUsDisponibles;
    }
    ...
    public String prepareCreate() {
        ...
        // obetengo la app        
        Iterator itApp = listApp.listIterator();
        while(itApp.hasNext()){
        ...
        if(idApp > 0){
            List<ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.Usuario> lstUsDisp = verUsuariosPorIdApp();
            Iterator itUsDisp = lstUsDisp.listIterator();
            while(itUsDisp.hasNext()){
                ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.Usuario usDisp = (ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.Usuario)itUsDisp.next();
    ...
    **********************/
    ...
    private void recreateModel() {
        listado.clear();
        listado = null;
        listUsDisponibles.clear();
        usSeleccionado = "";
    }       
    
    /**
     * Método para levantar las aplicaciones disponibles para asociar a un usuario
     * @return 
     */
    ...
    private List<ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.Usuario> verUsuariosPorIdApp(){
        List<ar.gob.ambiente.servicios.gestionpersonas.wsClient.accesoApp.Usuario> result;
